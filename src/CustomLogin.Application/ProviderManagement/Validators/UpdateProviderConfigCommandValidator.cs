...
namespace CustomLogin.Application.ProviderManagement.Validators;

public sealed class UpdateProviderConfigCommandValidator : AbstractValidator<UpdateProviderConfigCommand>
{
